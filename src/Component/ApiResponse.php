...
class ApiResponse extends JsonResponse
{
    ...
    public function addMessage(string $type, string $message): ApiResponse
    {
    ...
    public function mergeMessages(string $type, array $messages): ApiResponse
    {
        if (array_key_exists($type, $this->apiMessages)) {
    ...
    public function clearMessages(?string $type = null): ApiResponse
    {
        if (null !== $type && array_key_exists($type, $this->apiMessages)) {
    ...
    public function addValidationIssue(string $component, string $message): ApiResponse
    {
        if ('' === $component) {
    ...
    public function mergeValidationIssues(string $component, array $messages): ApiResponse
    {
        if ('' === $component) {
            $component = self::VALID_ROOT;
        }
    ...
    public function clearValidation(?string $component = null): ApiResponse
    {
    ...
    public function setThrowable(?Throwable $throwable): ApiResponse
    {
